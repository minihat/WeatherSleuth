<html>
<head>
<title>Weathersleuth Popular</title>
...
<h3 id="side_header">Connect with Me</h3>
<a href="https://www.facebook.com/"><img class="soc_med" src="icon_Facebook.png" alt="Facebook Button"></a>
...
<p id="sub_para">Enter your email below to begin recieving our newsletter</p>
...
echo '<input type=button value="Prev Page" onClick="self.location=\'popular.php?post_number=';
if($post_num -8 >= 1){
	echo $post_num - 8;
}else{
	echo '1';
...
echo  '\'">';
echo '<input type=button value="Next Page" onClick="self.location=\'popular.php?post_number=';
echo $post_num + 8;
echo '\'">';
...
<ul id="bot_list">
<li id="copy">&copy2016</li>
<li id="foot_title">Weathersleuth</li>
<li id="foot_link"><a href="home.html">&#9830; Home</a></li>
<li id="foot_link"><a href="recent.php">&#9830; Most Recent</a></li>
<li id="foot_link"><a href="popular.php">&#9830; Most Popular</a></li>
